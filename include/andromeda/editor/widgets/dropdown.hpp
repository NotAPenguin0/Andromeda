...
public:
    ...
    */
    DropDown(std::string const& name, std::string const& preview, It begin, It end, std::function<bool(T const&)> display) requires std::same_as<typename It::value_type, T>: selected(end), end_it(end) {
